package com.sevenCool.fileManager
{
	...
	public class FileManager extends EventDispatcher
	{
		 ...
		 * 加载图片
		 * */
		public function loadImage(arr:Array):void
		{
		 ...
		 * 素材加载
		 * */
		private function onMaterImgComplete(e:Event):void
		{
			var materLoader:MaterLoader = e.target  as MaterLoader;
			var bitmap:Bitmap = (e.currentTarget as LoaderInfo).content as Bitmap;
//			 imageDic[materLoader.imagevo.url] = bitmap ;
		}
